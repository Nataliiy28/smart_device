...
/* harmony import */ var _modules_modals_button_hidden__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/button-hidden */ "./js/modules/modals/button-hidden.js");
/* harmony import */ var _modules_modals_button_hidden__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_button_hidden__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_3__);




'use strict';
var ButtonConsalt = document.querySelector('.page-header__button-consultation');
var MobileWidth = 768;
var ButtonText = 'Бесплатная консультация';
var BODY_ELEMENT = document.querySelector('body');
var CallbackButtonConsalt = document.querySelector('.page-header__button-call');
var PopupModal = document.querySelector('.modal');
var Overly = document.querySelector('.overlay');
var CloseElement = PopupModal.querySelector('.modal__close');
var UsserName = PopupModal.querySelector('[name=name]');
var UsserPhone = PopupModal.querySelector('[name=phone]');
var MassageText = PopupModal.querySelector('[name=callback-text]');
var QuestionText = document.querySelector('[name=question-text]');
var KeyEsc = 27;
var KeyEnter = 13;
...
var popupBg = document.querySelector('.modal__wrapper'); // Фон попап окна
var popup = document.querySelector('.modal'); // Само окно
var openPopupButtons = document.querySelectorAll('.page-header__button-consultation'); // Кнопки для показа окна
var closePopupButton = document.querySelector('.modal__close'); // Кнопка для скрытия окна
...
document.querySelector('.modal__close').addEventListener('click', function (e) {
  var closePopupButton = document.querySelector('.modal');
...
//----------------------------------кнопка аккордиона +-
if (screen.width < 768) {
  var PlusButtonElement = document.querySelectorAll('.page-footer__title');
  PlusButtonElement.forEach(function (element) {
...
/***/ "./js/modules/modals/button-hidden.js":
/*!********************************************!*\
  !*** ./js/modules/modals/button-hidden.js ***!
  \********************************************/
...
var aboutBlok = document.querySelector('.about-company__text-detalied');
if (aboutButton) {
...
// about-company__text-detalied .about-company__text-detalied--active .about-company__text-detalied
