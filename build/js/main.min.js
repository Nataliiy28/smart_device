...
try {
  localStorage.getItem('user-name'), _readOnlyError("storageUserName");
  localStorage.getItem('user-phone'), _readOnlyError("storageUserPhone");
  localStorage.getItem('message'), _readOnlyError("storageText");
  localStorage.getItem('question'), _readOnlyError("storageQuestion");
} catch (err) {
...
$(function () {
  ...
  .not('[href="#"]').not('[href="#0"]').click(function (event) {
    ...
    if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
      ...
      target.length ? target : $('[name=' + this.hash.slice(1) + ']'), _readOnlyError("target");
...
var btn = document.querySelector('.about-company__button');
btn.addEventListener('click', function () {
  btn.innerHTML = btn.innerHTML === 'Подробнее' ? btn.innerHTML = 'Скрыть всё' : btn.innerHTML = 'Свернуть';
});
